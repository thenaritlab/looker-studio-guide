...
> ⏱ **เวลาโดยประมาณ:** 15 นาที · 📅 **วันตาม Roadmap:** สัปดาห์ 1 · วันที่ 1 (จ. 7 ก.ย. 2569) · 🎯 **ระดับ:** —
...
- ภาพประกอบเป็น placeholder (`assets/images/chXX-YY.png`) เพื่อให้คู่มือยังถูกต้องแม้ UI จะเปลี่ยนเล็กน้อย ตัวหนังสือจะอธิบายลำดับการคลิกไว้ครบเสมอ
